...
.. list-table::
   ...
   * - ``choice``
     - string
     - The unique identifier for the answer that the user selected. 


``xblock.poll.view_results``
************************************

The server emits an ``xblock.poll.view_results`` event when a tally of poll
responses is displayed to a user. For poll questions that have the **Private
...
.. list-table::
   ...
   * - ``choices``
     - object
     - A set of name/value pairs that identify the responses that the user
       selected for each question in the survey, in the format
...
**Private Results** option set to False, the matrix appears after a user
