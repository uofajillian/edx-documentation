...
.. image:: ../../../shared/building_and_running_chapters/Images/Rerandomize.png
 :alt: An image same problem shown twice, with color highlighting on values
     that can change.
 :width: 800

If you want to change, or "randomize," specific values in your problem, you
have to do both of the following steps.
...
This setting defines when the problem shows the answer to the learner and has
...
This setting specifies the number of seconds a learner must wait between
...
.. image:: ../../../shared/building_and_running_chapters/Images/problem_attempt_timer.png
 :alt: An image of a Problem with message that learner must wait before  
...
multiple choice question about the numerical input problem. Or, you might want
